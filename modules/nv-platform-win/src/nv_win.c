...
NV_INTERNAL int nv_win_tray_create(long long id, const char* icon_path, const char* tooltip, nv_window_t* w);
...
NV_INTERNAL int nv_win_tray_set_menu(long long id, const char** labels, const long long* item_ids, int count);
...
NV_INTERNAL void nv_win_dialog_message_async(const char* title, const char* body, const char* type,
                                             const char** buttons, size_t btn_count, nv_dialog_ctx_t* ctx,
                                             nv_dialog_cb_t cb);
NV_INTERNAL void nv_win_dialog_confirm_async(const char* title, const char* body, nv_dialog_ctx_t* ctx,
                                             nv_dialog_cb_t cb);
...
NV_INTERNAL void nv_app_platform_init(nv_app_t* app) {
  ...
  app->platform_api.platform_name = "win";
  app->platform_api.shell_open_url = nv_win_shell_open_url;
  app->platform_api.shell_open_path = nv_win_shell_open_path;
  app->platform_api.shell_show_in_folder = nv_win_shell_show_in_folder;
  app->platform_api.shell_exec = nv_win_shell_exec;
  app->platform_api.clipboard_read_text = nv_win_clipboard_read_text;
  app->platform_api.clipboard_write_text = nv_win_clipboard_write_text;
  app->platform_api.clipboard_clear = nv_win_clipboard_clear;
  app->platform_api.clipboard_has_text = nv_win_clipboard_has_text;
  app->platform_api.clipboard_read_image = nv_win_clipboard_read_image;
  app->platform_api.clipboard_write_image = nv_win_clipboard_write_image;
  app->platform_api.clipboard_has_image = nv_win_clipboard_has_image;
  app->platform_api.notification_show = nv_win_notification_show;
  app->platform_api.notification_close = nv_win_notification_close;
  app->platform_api.screen_get_all = nv_win_screen_get_all;
  app->platform_api.screen_get_primary = nv_win_screen_get_primary;
  app->platform_api.screen_get_cursor = nv_win_screen_get_cursor;
  app->platform_api.tray_create = nv_win_tray_create;
  app->platform_api.tray_destroy = nv_win_tray_destroy;
  app->platform_api.tray_set_icon = nv_win_tray_set_icon;
  app->platform_api.tray_set_tooltip = nv_win_tray_set_tooltip;
  app->platform_api.tray_set_menu = nv_win_tray_set_menu;
  app->platform_api.fs_watch_start = nv_win_fs_watch_start;
  app->platform_api.fs_watch_stop = nv_win_fs_watch_stop;
  app->platform_api.dialog_open_file_async = nv_win_dialog_open_file_async;
  app->platform_api.dialog_save_file_async = nv_win_dialog_save_file_async;
  app->platform_api.dialog_open_folder_async = nv_win_dialog_open_folder_async;
  app->platform_api.dialog_message_async = nv_win_dialog_message_async;
  app->platform_api.dialog_confirm_async = nv_win_dialog_confirm_async;
  app->platform_api.app_get_data_dir = nv_win_get_data_dir;
  app->platform_api.app_get_exe_path = nv_win_get_exe_path;
  app->platform_api.app_get_resource_dir = nv_win_get_resource_dir;
  app->platform_api.app_get_locale = nv_win_get_locale;
  ...
  app->platform_api.window_set_context_menu = nv_win_window_set_context_menu;
  app->platform_api.hotkey_register = nv_win_register_hotkey;
  app->platform_api.hotkey_unregister = nv_win_unregister_hotkey;
